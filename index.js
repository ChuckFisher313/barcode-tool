...
function GenerateCheckDigit(){
  ...
  var input_barcode = NormalizeUPC(document.getElementById('input_barcode').value);
  ...
  document.getElementById('barcode_result').innerHTML = 'Type: ' + input_barcodetype + ': ' + barcode;
}

function NormalizeUPC(orig_barcode){
  console.log('NormalizeUPC: invoked');
  var normalizedUPC = '0000000000000'+orig_barcode;
  normalizedUPC = normalizedUPC.substring(normalizedUPC.length - 13, normalizedUPC.length);
